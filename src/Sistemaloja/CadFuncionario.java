...
public class CadFuncionario extends javax.swing.JFrame {
   ...
   //ArrayList<Funcionario> funcionarios = new ArrayList();
    ...
    private void initComponents() {
        ...
        textoNumeroRg.setBounds(240, 140, 200, 20);
        ...
        textoContato.setBounds(500, 140, 100, 20);
        ...
        jButton3.setBounds(580, 360, 90, 23);
        ...
        jScrollPane1.setBounds(60, 390, 650, 160);
        ...
        adicionar.setBounds(340, 360, 90, 23);
        ...
        apagar.setBounds(460, 360, 90, 23);
    ...
    private void adicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_adicionarActionPerformed
        ...
        //int idade = Integer.valueOf(textoIdade.getText());
       ...
       /*Funcionario fun = new Funcionario();
        ...
        fun.setIdade(idade);
        fun.setContato(contato);
        fun.setEndereco(endereco);
        fun.setProfissao(profissao);
